...
void Interpreter_Context::print (void){
...
void Interpreter_Context::reset (void){
  map_.clear ();
}
...
// returns the precedence level
int Number::add_precedence (int precedence){
  return this->precedence_ = 4 + precedence;
}

// builds an equivalent expression tree node
Component_Node<int> * Number::build (void){
  // You fill in here.
...
// returns the precedence level
int  Negate::add_precedence (int precedence){
  return this->precedence_ = 3 + precedence;
}

// builds an equivalent expression  tree node
Component_Node<int> * Negate::build (){
  // You fill in here.
...
// returns the precedence level
int Add::add_precedence (int precedence){
  return this->precedence_ = 1 + precedence;
}

// builds an equivalent expression tree node
Component_Node<int> * Add::build (void){
  // You fill in here.
...
// returns the precedence level
int Subtract::add_precedence (int precedence){
  return this->precedence_ = 1 + precedence;
}

// builds an equivalent expression tree node
Component_Node<int> * Subtract::build (void){
  // You fill in here.
...
// returns the precedence level
int Multiply::add_precedence (int precedence){
	return this->precedence_ = 2 + precedence;
}

// builds an equivalent expression tree node
Component_Node<int> * Multiply::build (void){
  // You fill in here.
...
// returns the precedence level
int Divide::add_precedence (int precedence){
  return this->precedence_ = 2 + precedence;
}

// builds an equivalent expression tree node
Component_Node<int> * Divide::build (void){
  // You fill in here.
...
void Interpreter::terminal_insert
(Symbol *terminal,std::list<Symbol *>& list){
	if (!list.empty ()){
...
void Interpreter::main_loop (Interpreter_Context & context,
                       const std::string &input,
                       std::string::size_type &i,
                       Symbol *& lastValidInput,
                       bool & handled,
...
TREE Interpreter::interpret (Interpreter_Context &context, 
                        const std::string &input){
  std::list<Symbol *> list;
  //list.clear ();
